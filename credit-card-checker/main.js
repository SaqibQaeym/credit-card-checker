...
/* Learn how to check if a credit card is valid in the link below
...
const validateCard = (arr) => {
    ...
    for (let i = arr.length-1; i >= 0; i--) {
        ...
        if (currentValue > 9) {
            currentValue = Math.floor(currentValue/10) + (currentValue % 10);
...
function idInvalidCardCompanies(invalidBatch) {
    ...
    for (let i = 0; i < invalidBatch.length; i++) {
        /*I copied this section of code from the solution
        I couldn't understand what (invalidBatch[i][0]) do */
